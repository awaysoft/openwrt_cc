...
// liudf 20150413
// set 100 to 200
#define MLME_TASK_EXEC_INTV         200/*200*/       /* */
#define LEAD_TIME                   5

// liudf 20150413
// tunning 10 to 50
#define MLME_TASK_EXEC_MULTIPLE       50  /*5*/       /* MLME_TASK_EXEC_MULTIPLE * MLME_TASK_EXEC_INTV = 1 sec */
...
// liudf 20150409
// Change ageout time from 300 to 5
// change min ageout time from 60 to 30
// change assoc timeout from 5 to 3
#define MAC_TABLE_AGEOUT_TIME			5			/* unit: sec */
#define MAC_TABLE_MIN_AGEOUT_TIME		30			/* unit: sec */
#define MAC_TABLE_ASSOC_TIMEOUT			3			/* unit: sec */
